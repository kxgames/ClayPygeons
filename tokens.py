...
class Quaffle(Sprite):
    ...
    def setup(self, world):
        ...
        self.add_behavior (Wander(self, 1, 35, 1, 7))
        #self.add_behavior (Seek(self, 1.0, self.world.get_sight(0), 100))
        #self.add_behavior (Flee(self, 1.0, self.world.get_sight(0), 100))
